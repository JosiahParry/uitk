---
title: "{uitk} - Urban Informatics Toolkit"
...
{uitk} is a package to go along with the [Urban Informatics Toolkit](https://ui.josiahparry.com) (U), an open text for the Northeastern Course SPPUA 5262 Big Data for Cities. The package contains datasets in the online text as well as a number of tutorials to accompany the code examples in the book. 

## Installation

This package does not yet exist on CRAN and must be installed directly from Github.
