...
- **Instructor**: Josiah Parry (parry.jo@northeastern.edu)
- **Office Hours**: 
- **Course Meets**: 
- **Required Texts**:
...
reading. We will jumpstart class discussion using the Canvas discussion board in advance of class.
  - Students will turn in their response to the reading prompt, which must be at least 250 words, on the Canvas discussion board designated for that week by Tuesday at noon.
  - Students will be expected to browse each other's responses as well. It will be required
to respond to at least one other student's response by class time on Wednesday.
...
- **Information**: Read-Me Documentation will provide a short series of facts derived from the
...
- 15% Information Mid-Term Project: Read-Me Document 15% Measurement Mid-Term Project: Original Measurement 25% Final Project (Paper and Presentation)
...
- Class will start promptly at 5:15. Please be on time. If you are late for any reason, please enter without disturbing the class.
- We will typically end by 8:15. This is a 4-credit course, which assumes 3 hrs. 20 min. of course time weekly. The remaining time will be put towards out-of-class viewing of online lectures.
- The use of communication devices during class will not be tolerated. Upon entering, please turn off all cellular phones and related devices. Please also keep computers off during activities and discussions that do not require them.
- Late assignments will be discounted 20% per weekday. After a week, they will no longer be accepted. If an assignment was to be posted online in advance of class to stimulate discussion there will be no opportunity for late credit.
